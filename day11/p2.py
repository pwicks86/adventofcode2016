...
floors[0].append(("elerium", "generator"))
floors[0].append(("elerium", "microchip"))
floors[0].append(("dilithium", "generator"))
floors[0].append(("dilithium", "microchip"))
floors[3] = []
...
while True:
    ...
    if is_goal_state(cur_state):
        ...
        break
    state_str = to_string(cur_state)
    if state_str in seen_states:
        continue
    else:
        seen_states.add(state_str)
    state_pairs = gen_pairs(cur_state)
